...
class GuiaTest {
    ...
    void deveCriarGuiaValida() {
        Guia guia = new Guia("FGTS", "EMPRESA EXEMPLO", 6, 2026,
    ...
    void deveRejeitarTipoGuiaVazio() {
        assertThrows(IllegalArgumentException.class, () ->
                new Guia("", "EMPRESA EXEMPLO", 6, 2026, LocalDate.of(2026, 6, 20),
    ...
    void deveRejeitarMesInvalido() {
        assertThrows(IllegalArgumentException.class, () ->
                new Guia("FGTS", "EMPRESA EXEMPLO", 13, 2026, LocalDate.of(2026, 6, 20),
                        UUID.randomUUID(), StatusGuia.CONCLUIDA));
    }
    ...
    void deveRejeitarStatusNulo() {
        assertThrows(IllegalArgumentException.class, () ->
                new Guia("FGTS", "EMPRESA EXEMPLO", 6, 2026, LocalDate.of(2026, 6, 20),
