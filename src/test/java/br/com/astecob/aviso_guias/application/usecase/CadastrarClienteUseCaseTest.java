...
class CadastrarClienteUseCaseTest {
    ...
    void deveCadastrarClienteQuandoEmpresaAindaNaoExiste() {
        when(clienteRepository.existePorNomeEmpresaNormalizado("EMPRESA EXEMPLO"))
                .thenReturn(false);
        ...
        assertEquals("Empresa Exemplo", cliente.getNomeEmpresa());
        assertEquals("EMPRESA EXEMPLO", cliente.getNomeEmpresaNormalizado());

        verify(clienteRepository)
                .existePorNomeEmpresaNormalizado("EMPRESA EXEMPLO");
