...
public class HistoricoNotificacaoRepositoryJpaAdapter implements HistoricoNotificacaoRepository {
    ...
    @Override
    public List<HistoricoNotificacao> listarTodos() {
    ...
    private HistoricoNotificacaoEntity toEntity(HistoricoNotificacao historico) {
        return new HistoricoNotificacaoEntity(
                historico.getId(),
                historico.getGuiaId(),
                historico.getNomeEmpresa(),
                historico.getEmail(),
                historico.getTelefoneWhatsapp(),
                historico.getCanal().name(),
                historico.getResultado().name(),
                historico.getDataHora(),
                historico.getMotivoFalha()
        );
    }
    ...
    private HistoricoNotificacao toDomain(HistoricoNotificacaoEntity entity) {
        return HistoricoNotificacao.restaurar(
                ...
                entity.getEmail(),
                entity.getTelefoneWhatsapp(),
                CanalNotificacao.valueOf(entity.getCanal()),
                ResultadoNotificacao.valueOf(entity.getResultado()),
                entity.getDataHora(),
